...
; GDT
gdt32_start:
gdt32_null: ; the mandatory null descriptor
    dd 0x0  ; ’ dd ’ means define double word ( i.e. 4 bytes )
    dd 0x0
gdt32_code:     ; the code segment descriptor
...
gdt32_data: ; the data segment descriptor
    ...
    db 11001111b ; 2 nd flags , Limit ( bits 16 -19)
    db 0x0 ; Base ( bits 24 -31)
gdt32_end:  ; The reason for putting a label at the end of the
            ; GDT is so we can have the assembler calculate
            ; the size of the GDT for the GDT decriptor ( below )

; GDT descriptior
gdt32_descriptor:
    dw gdt32_end - gdt32_start - 1 ; Size of our GDT , always less one
    ; of the true size
    dd gdt32_start ; Start address of our GDT
